...
public class MyHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sql="create table "+TABLE_NAME6+"(" +
                ...
                "appid varchar(30),"+//商家接入id
                "key_num varchar(10),"+//根秘钥个数
                "mac_key_list varchar(1024),"+//根密钥列表
                "result_code varchar(20),"+//业务结果
                "err_code varchar(10),"+//错误代码
                "err_code_des varchar(20),"+//错误代码描述
                "flag varchar(10),"+ //标记
                "optiontime varchar(30))";//操作时间
        db.execSQL(sql);
    }
    /**数据库版本升级时调用*/
    @Override
